                        ...
                        <div className="max-w-md w-full text-center space-y-6">
                            ...
                            {orderDetails ? (
                                <div className="bg-card border border-border rounded-xl p-6 mt-8 space-y-4 text-left">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 border-b border-border pb-4 pt-4">
                                        <div>
                                            <p className="text-sm text-muted-foreground">Order Status</p>
                                            <p className="font-medium text-foreground capitalize">{orderDetails.status?.toLowerCase()}</p>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-sm text-muted-foreground">Payment Status</p>
                                            <p className={`font-medium ${orderDetails.paymentStatus === 'SUCCESS' ? 'text-green-600' : 'text-red-600'} capitalize`}>
                                ...
                                orderId && (
                                    <div className="bg-card border border-border rounded-xl p-4 mt-8">
                                        <p className="text-sm text-muted-foreground mb-1">Order details not found</p>
                                    </div>
                                )
                            )}
